...
# plt.rcParams['font.family'] = ['Times New Roman']  # 默认字体
plt.rcParams['axes.unicode_minus'] = False    # 正负号显示
fig, axes = plt.subplots(2, 2, figsize=(12, 12), subplot_kw={'projection': 'polar'})
data_files = {
    'Greedy': '../plans/plan_Greedy_202501231400_1.0_62_43.262_gaia300-0.csv',
    'Random': '../plans/plan_Random_202501231530_1.0_47_24.850_gaia300.csv',
    'RL-GR-1': '../plans/plan_RL_202501231400_1.0_83_53.669_gaia300-0.csv',
    'RL-GR-2': '../plans/plan_RL_202501231530_1.0_82_48.758_gaia300-0.csv',

}

site_location = EarthLocation.from_geodetic(74.893245 * u.deg, 38.335449 * u.deg, 4490 * u.m)
ai = 0
for ad in data_files:
    ...
    for item in items:
        ...
        coord = SkyCoord(ra=item['RA'], dec=item['Dec'], unit='deg')
        altaz_frame = AltAz(obstime=start_time, location=site_location)
        target_altaz = coord.transform_to(altaz_frame)

        azimuths.append(target_altaz.az.value)
        altitudes.append(target_altaz.alt.value)
...
cbar.set_label('Score', fontsize=12, labelpad=0)
